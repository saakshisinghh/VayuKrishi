...
export function DashboardGrid() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 3+4. AI Recommendations + Disease Alerts side by side on desktop */}
      <Section delay={0.1}>
      ...
      {/* 5+6. Market + Health side by side on desktop */}
      <Section delay={0.15}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Market */}
          <div>
      ...
      {/* 7+8. Schemes + Voice side by side */}
      <Section delay={0.2}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Government Schemes */}
          <div>
