          ...
          return (
            <li key={stepNumber} className="flex flex-1 items-center">
              <div className="flex flex-1 flex-col items-center gap-1">
                <motion.div
                  ...
                  className={cn(
                    ...
                    isCurrent && 'text-white shadow-lg shadow-emerald-500/30',
                    isUpcoming && 'text-gray-400 dark:bg-gray-700 dark:text-gray-500'
                  )}
              ...
              {index < steps.length - 1 && (
                <div className="relative mx-1 h-0.5 flex-1 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
                  <motion.div
                    initial={false}
  ...
  return (
    ...
    >
      <div className="mb-6 flex items-start gap-3">
        <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-400">
          {icon}
        </div>
        <div>
